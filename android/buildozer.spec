...
# pycryptodomex, curl_cffi and charset-normalizer (via requests) are left
# out: they ship native code the build cannot install, and yt-dlp works
# without them through Python's own HTTP client (TikTok may refuse
# downloads without curl_cffi).
requirements = python3,kivy==2.3.1,pyjnius,android,udtools,yt-dlp==2026.8.19,yt-dlp-ejs==0.8.0,certifi==2026.7.22,mutagen==1.48.1
