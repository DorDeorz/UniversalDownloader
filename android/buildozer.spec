...
# yt-dlp works without them (TikTok may refuse downloads without
# curl_cffi). charset_normalizer is a local recipe too, see its docstring.
requirements = python3,kivy==2.3.1,pyjnius,android,udtools,charset_normalizer,yt-dlp==2026.8.19,yt-dlp-ejs==0.8.0,certifi==2026.7.22,mutagen==1.48.1
